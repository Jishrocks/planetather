    ...
    return (
        <>
            <Page title="License" subtitle="Legal stuff. An agreement between you and Stratos Labs">
                ...
                <div>
                    <h1 style={{fontFamily: 'GalderGlynn'}}>Definitions</h1>
                    ...
                    maxWidth: '1000px',
                    fontFamily: 'Mono', lineHeight: '2', marginTop: '2.5rem'}}>
                        "Stratos Labs", "us", "we" or "our" means Stratos Labs Inc and/or its affiliates.
                ...
                <div>
                    <h1 style={{fontFamily: 'GalderGlynn'}}>License Grant</h1>
                    ...
                    maxWidth: '1000px',
                    fontFamily: 'Mono', lineHeight: '2', marginTop: '2.5rem'}}>
                    Ather NFT Art License. For as long as you lawfully own your Ather NFT, and subject to your compliance with the terms of this License, we hereby grant you the following rights:
                    </motion.p>
                    <ul className="content" style={{fontSize: screenBasedAttribute(screens, {
                        screen_sm: '14px',
                        screen_md: '14px',
                        screen_lg: '15px',
                        screen_xl: '18px'
