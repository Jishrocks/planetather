        ...
        {/* <img src="../images/synthpop.jpeg" style={{height: '120vh', position: 'absolute', opacity: 0.1}} alt="" /> */}
            ...
            <Grid container gap={6}>
                <Grid item sx={{display: 'flex', flexDirection: 'column'}} xs>
                    {/* <Box sx={{display: 'flex', alignItems: 'center', justifyContent: 'center', marginLeft: '1rem', gap: 2}}>
                        <motion.div
                        initial={{
                    ...
                    <Box style={{justifyContent: 'center'}}>
                        <h1 style={{fontFamily: 'Mandalore', opacity: 0.7, textAlign: 'center', color: '#fff', fontSize: '10rem', marginBlock: '0rem', textTransform: 'lowercase', lineHeight: 1}}>
                            We are
                        </h1>
                        <h1 style={{fontFamily: 'Mandalore', textAlign: 'center', color: '#fff', fontSize: '20rem', marginBlock: '0rem', textTransform: 'lowercase', textShadow: '0 0 0px rgb(192 219 255 / 48%), 0 0 16px rgb(65 120 255 / 24%)', lineHeight: 0.78}}>
                    ...
                    <Box style={{display: 'flex', justifyContent: 'center', marginTop: '2rem'}}>
                        ...
                        <img onClick={() => {
                            ...
                            // }
                        }} width={"auto"} height={"100px"} src={"/images/logov2.png"} style={{marginRight: '10px', cursor: 'pointer', opacity: 0.3}}></img>
                    </Box>
                </Grid>
